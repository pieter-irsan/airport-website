						...
						<div class="col-sm-9">
							...
							<div class="proj-table-style proj-table-striped">
								<div class="table-responsive">
									...
									<a href="create_departure.php">[+]	Add Departure Flight</a>
                                        ...
                                        <table id="tablefids" class="dataTable no-footer" role="grid" aria-describedby="tablefids_info" style="width: 847px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 85px;">Destination</th>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    while($flight = mysqli_fetch_array($query)){
                                                        ...
                                                        echo "<td>";
                                                        echo "<a href='update_departure.php?kode_penerbangan=".$flight['kode_penerbangan']."'>Update</a> | ";
                                                        echo "<a href='delete_departure.php?kode_penerbangan=".$flight['kode_penerbangan']."'>Delete</a>";
                                                        echo "</td>";
