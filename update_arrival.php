...
$sql = "SELECT * FROM kedatangan WHERE kode_penerbangan='$kode_penerbangan'";
						...
						<div class="col-sm-9">
							...
							<div class="proj-table-style proj-table-striped">
								<div class="table-responsive">
									...
									<a href="admin_arrival.php">Return<br><br></a>
                                    <form action="process_update_a.php" method="POST">
										<fieldset>
										<p>
										...
										<p>
											<label for="asal">Origin: </label>
											<?php $asal = $flight['asal']; ?>
											<select name="asal">
												<option disabled>Jawa</option>
												<option disabled>──────────</option>
												<option <?php echo ($asal == 'CGK - Banten') ? "selected": "" ?>>CGK - Banten</option>
												<option <?php echo ($asal == 'HLP - Jakarta') ? "selected": "" ?>>HLP - Jakarta</option>
												<option <?php echo ($asal == 'SUB - Surabaya') ? "selected": "" ?>>SUB - Surabaya</option>
												<option <?php echo ($asal == 'SOC - Solo') ? "selected": "" ?>>SOC - Solo</option>
												<option <?php echo ($asal == 'JOG - Yogyakarta') ? "selected": "" ?>>JOG - Yogyakarta</option>
												<option <?php echo ($asal == 'SRG - Semarang') ? "selected": "" ?>>SRG - Semarang</option>
												<option <?php echo ($asal == 'BDO - Bandung') ? "selected": "" ?>>BDO - Bandung</option>
												<option <?php echo ($asal == 'PCB - Pamulang') ? "selected": "" ?>>PCB - Pamulang</option>
												<option <?php echo ($asal == 'PPJ - Kepulauan Seribu') ? "selected": "" ?>>PPJ - Kepulauan Seribu</option>
												<option <?php echo ($asal == 'TSY - Tasikmalaya') ? "selected": "" ?>>TSY - Tasikmalaya</option>
												<option <?php echo ($asal == 'CBN - Cirebon') ? "selected": "" ?>>CBN - Cirebon</option>
												<option <?php echo ($asal == 'CXP - Cilacap') ? "selected": "" ?>>CXP - Cilacap</option>
												<option <?php echo ($asal == 'PWL - Purbalingga') ? "selected": "" ?>>PWL - Purbalingga</option>
												<option <?php echo ($asal == 'KWB - Karimunjawa') ? "selected": "" ?>>KWB - Karimunjawa</option>
												<option <?php echo ($asal == 'CPF - Cepu') ? "selected": "" ?>>CPF - Cepu</option>
												<option <?php echo ($asal == 'MLG - Malang') ? "selected": "" ?>>MLG - Malang</option>
												<option <?php echo ($asal == 'SUP - Sumenep') ? "selected": "" ?>>SUP - Sumenep</option>
												<option <?php echo ($asal == 'MSI - Masalembo') ? "selected": "" ?>>MSI - Masalembo</option>
												<option disabled>──────────</option>
												<option disabled>Bali & Nusa Tenggara</option>
												<option disabled>──────────</option>
												<option <?php echo ($asal == 'DPS - Denpasar') ? "selected": "" ?>>DPS - Denpasar</option>
												<option <?php echo ($asal == 'AMI - Mataram') ? "selected": "" ?>>AMI - Mataram</option>
												<option <?php echo ($asal == 'KOE - Kupang') ? "selected": "" ?>>KOE - Kupang</option>
											</select>
										</p>
										<p>
