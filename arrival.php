					...
					<div class="row">
						<div class="col-sm-9">
							<div id="proj-fids-sort" class="tab">
								...
								<div class="proj-fids-sort-btn proj-fids-sort"><a href="departure.php" class="proj-btn full b-grey nocorner">Departure</a></div>
								<div class="proj-fids-sort-btn proj-fids-sort"><a href="arrival.php" class="proj-btn full b-primary nocorner">Arrival</a></div>
							</div>
                                        ...
                                        <table id="tablefids" class="dataTable no-footer" role="grid" aria-describedby="tablefids_info" style="width: 847px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 67px;">Origin</th>
